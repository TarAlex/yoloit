        ...
        MultiBlocProvider(
          providers: [
            ...
            BlocProvider<WorkspaceCubit>(
              create: (_) => WorkspaceCubit()
                ..emit(const WorkspaceLoaded(
                  workspaces: [Workspace(id: 'ws_1', name: 'project', path: '/proj')],
                  activeWorkspaceId: 'ws_1',
                )),
            ),
          ],
    ...
    testGoldens('empty review panel', (tester) async {
      await tester.pumpWidgetBuilder(
        BlocProvider<ReviewCubit>(
          create: (_) => ReviewCubit()..emit(const ReviewInitial()),
          child: _shell(child: const ReviewPanel(), width: 360, height: 800),
        ),
